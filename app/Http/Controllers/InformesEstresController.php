...
{
    public function generarInformeEstres($fichadatos){
        $tabla = Auth::user()->nivelSeguridad == config('constants.TIPO_B') ? 'estres1a' : 'estres1';
        $criterios_suma1 = Auth::user()->nivelSeguridad == config('constants.TIPO_B') ? 'estres1a + estres2a + estres3a + estres4a + estres5a + estres6a + estres7a + estres8a' : 'estres1 + estres2 + estres3 + estres4 + estres5 + estres6 + estres7 + estres8';
        $criterios_suma2 = Auth::user()->nivelSeguridad == config('constants.TIPO_B') ? 'estres9a + estres10a + estres11a + estres12a' : 'estres9 + estres10 + estres11 + estres12';
        $criterios_suma3 = Auth::user()->nivelSeguridad == config('constants.TIPO_B') ? 'estres13a + estres14a + estres15a + estres16a + estres17a + estres18a + estres19a + estres20a + estres21a + estres22a' : 'estres13 + estres14 + estres15 + estres16 + estres17 + estres18 + estres19 + estres20 + estres21 + estres22';
        $criterios_suma4 = Auth::user()->nivelSeguridad == config('constants.TIPO_B') ? 'estres23a + estres24a + estres25a + estres26a + estres27a + estres28a + estres29a + estres30a + estres31a' : 'estres23 + estres24 + estres25 + estres26 + estres27 + estres28 + estres29 + estres30 + estres31';
        ...
        $rango = Auth::user()->nivelSeguridad == config('constants.TIPO_B') ? [6.5,11.8,17,23.4,100] : [7.8,12.6,17.7,25,100];   
